...
module.exports = () => ({
  resolve: {
    alias: {
      ...
      './js/LoginModal.js': path.resolve(__dirname, 'template/js/custom-js/components/LoginModal.js'),
      ...
      './html/EcOrdersList.html': path.resolve(__dirname, 'template/js/custom-js/components/EcOrdersList.html'),
